 ...
 *
 */
public class LogCircularBuffer {
	...
	public LogCircularBuffer(int capacity) throws BufferMaxCapacityException{
	...
	public int write(LogEntry log) throws BufferOverflowException{
		...
		if(!logIndex.containsKey(clientId)){
			HashMap<Long,Pair> messages = new HashMap<Long, LogCircularBuffer.Pair>();
